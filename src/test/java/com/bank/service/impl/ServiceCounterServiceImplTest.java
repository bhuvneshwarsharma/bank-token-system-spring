...
public class ServiceCounterServiceImplTest extends BankTokenSystemApplicationTests{
    ...
    @Before
    public void setUp() {
        ServiceCounter counter1 = new ServiceCounter("D1", ServiceType.DEPOSIT.toString(), EntityType.PREMIUM.toString(), null);
        ServiceCounter counter2 = new ServiceCounter("D2", ServiceType.DEPOSIT.toString(), EntityType.REGULAR.toString(), null);
