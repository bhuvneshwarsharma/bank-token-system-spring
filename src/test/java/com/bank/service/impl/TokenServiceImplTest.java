...
public class TokenServiceImplTest extends BankTokenSystemApplicationTests {
    ...
    public void setUp() {
        ...
        Customer customer = new Customer("Bhuvi", "7897952579", "Hyderabad", EntityType.PREMIUM.toString());
        CustomerToken customerToken = new CustomerToken("CREATED", ServiceType.DEPOSIT.toString(), new Date(), customer);
        ServiceCounter counter = new ServiceCounter("D1", ServiceType.DEPOSIT.toString(), EntityType.PREMIUM.toString(), null);
