 ...
 */
public class WithdrawServiceCounter implements IBankServiceCounter {

    Map<String, Queue<CustomerToken>> tokenTaskList= new HashMap<String, Queue<CustomerToken>>();
    static WithdrawServiceCounter accountServiceCounter = null;
    ...
    public static WithdrawServiceCounter getInstance() {
        ...
        if(accountServiceCounter==null)
            accountServiceCounter = new WithdrawServiceCounter();
